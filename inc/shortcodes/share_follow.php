...
function flatsome_follow($atts, $content = null) {
    ...
    <div class="social-icons follow-icons <?php echo $align; ?>" <?php echo $scale;?>>
	    ...
	    <?php }?>
	    <?php if($linkedin){?>
		       <a href="<?php echo $linkedin; ?>" target="_blank" rel="nofollow" data-label="LinkedIn" class="<?php echo $style; ?>  linkedin tooltip" title="<?php _e('Follow on LinkedIn','flatsome') ?>"><i class="fa fa-linkedin" aria-hidden="true"></i><?php //echo get_flatsome_icon('icon-linkedin'); ?></a>
		<?php }?>
		<?php if($pinterest){?>
