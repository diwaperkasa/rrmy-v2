        ...
        <div class="container">
            <div class="py-3 py-md-5">
                <div class="offcanvas-header justify-content-between align-items-start">
                                ...
                                <div class="my-3 my-md-0">
                                    <form action="<?= home_url() ?>" method="get">
                                        <div class="input-group">
                                            ...
                                            <input name="s" type="search" class="placeholder-secondary bg-transparent form-control border-0 rounded-0 border-bottom text-white mulish" type="search" placeholder="Type your keywords..." required />
                                        </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="bg-danger rounded-circle p-1 d-none d-md-block">
                        <button style="--bs-btn-close-opacity: 1;" type="button" class="m-1 btn-close text-reset invert-color" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                    </div>
                </div>
            </div>
                            ...
                            <div class="py-2">
                                ...
                                <ul class="list-unstyled">
                                    <?php foreach ($menu['children'] as $childMenu): ?>
                                        <li class="mb-2"><a target="<?= $childMenu["target"] ?>" href="<?= $childMenu['url'] ?>" class="text-white text-uppercase text-decoration-none text-danger-hover transition-color-hover fs-6 mulish ls-3"><?= $childMenu['title'] ?></a></li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="position-relative subsribe-popup d-none">
                    <div class="position-absolute w-100">
                        <div class="container bg-white border-top shadow">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 d-none d-md-block">
                                                <div class="py-3">
                                                    ...
                                                    <div>
                                                        <a href="/print-subscription" class="text-uppercase text-white btn btn-danger rounded-0 px-4 py-2 ls-1"><span class="mulish fw-light">PRINT</span></a>
                                                        <a target="_blank" href="https://www.magzter.com/MY/Indochine-Media/Robb-Report-Malaysia/Lifestyle/?utm_source=cj-cps&cjevent=612b9ff3d3dd11f0829401a20a18b8f6" class="text-uppercase text-white btn btn-danger rounded-0 px-4 py-2 ls-1"><span class="mulish fw-light">DIGITAL</span></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="position-relative search-popup d-none">
                    <div class="position-absolute w-100 border-top shadow">
                                        ...
                                        <div class="col-md-10">
                                            <form action="<?= home_url() ?>" method="get">
                                                <div class="input-group">
                                                    ...
                                                    <input name="s" type="search" class="bg-transparent form-control border-0 rounded-0 border-bottom border-black mulish" type="search" placeholder="Type your keywords..." required />
                                                </div>
                                            </form>
                                        </div>
                                    </div>
