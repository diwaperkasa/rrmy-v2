            ...
            <div class="offcanvas-body">
                <div class="row">
                    <div class="col-md-6 mb-5 mb-md-0">
                        ...
                        <p class="lora">Sign up for the Robb Report Malaysia weekly newsletter for the latest from the universe of luxury.</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 py-4">
                                        <div class="py-3 px-5 border-start">
                                            ...
                                            <p class="text-center mb-4 mulish-light ls-1">Sign up for the Robb Report Malaysia weekly newsletter for the latest from the universe of luxury.</p>
                                            <form target="_blank" action="https://robbreport.us12.list-manage.com/subscribe/post?u=28729885bbfbb9568a4580c7b&id=6523a24d0a" method="POST">
