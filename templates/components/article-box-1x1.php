<article <?php post_class('h-100 mb-4', get_the_ID()) ?>>
    <div class="h-100 d-flex flex-column justify-content-between h-100 bg-white">
        ...
        <div class="article-footer">
            ...
            <div class="article-writter fw-light mb-4">
                <span>
