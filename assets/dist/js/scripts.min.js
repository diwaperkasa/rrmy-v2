...
var navbarAnimation = function navbarAnimation() {
  ...
  if (desktopNavMenuPosition.top > 0) {
    ...
    if (navbarContainer.classList.contains('border-bottom')) {
      ...
      (_navbarContainer$clas = navbarContainer.classList).remove.apply(_navbarContainer$clas, ['border-bottom', 'border-black', 'border-2']);
    }
  } else {
    hiddenMenu.forEach(function (element) {
      if (element.classList.contains('d-none')) {
    ...
    if (!navbarContainer.classList.contains('border-bottom')) {
      ...
      (_navbarContainer$clas2 = navbarContainer.classList).add.apply(_navbarContainer$clas2, ['border-bottom', 'border-black', 'border-2']);
    }
  }
};
navbarAnimation();
