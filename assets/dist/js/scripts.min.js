...
_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
  var lastScroll, navbar, subsribeHover, subsribePopup, subsribePopupContainer, searchBtn, searchPopup, searchPopupContainer, imageGalleries, carouselGallery, flkty, carouselNav, moreCategoryArticle, page, length, term_id;
      ...
      case 0:
        ...
        if (carouselGallery) {
          ...
          flkty.on('change', function () {
            ...
            var element = document.querySelector('#carousel-nav-' + id);
            if (element) {
