...
/* harmony import */ var sharer_js_sharer_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! sharer.js/sharer.min.js */ "./node_modules/sharer.js/sharer.min.js");
/* harmony import */ var sharer_js_sharer_min_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(sharer_js_sharer_min_js__WEBPACK_IMPORTED_MODULE_1__);
...
_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
  var lastScroll, navbar, headerTop, subsribeHover, subsribePopup, subsribePopupContainer, topMenuHeader, searchBtn, searchPopup, searchPopupContainer, imageGalleries, carouselGallery, flkty, carouselNavigationGallery, flktyNavGallery, carouselNav, moreCategoryArticle, page, length, term_id, moreArticle, _page, _length;
    ...
    while (1) switch (_context6.n) {
      case 0:
        ...
        window.addEventListener("scroll", function () {
          ...
          var offsetHeight = navbar.offsetHeight + headerTop.offsetHeight;
          // Shadow activation
        ...
        subsribeHover = document.querySelectorAll('.subsribe-hover');
        subsribePopup = document.querySelector('.subsribe-popup');
        subsribePopupContainer = document.querySelector('.subsribe-popup-container');
        topMenuHeader = document.querySelectorAll('.top-header-menu');
        subsribeHover.forEach(function (element) {
        ...
        subsribePopupContainer.addEventListener('mouseleave', function () {
          if (!subsribePopup.classList.contains('d-none')) {
            subsribePopup.classList.add('d-none');
          }
        });
        topMenuHeader.forEach(function (element) {
          element.addEventListener('mouseenter', function () {
            if (!subsribePopup.classList.contains('d-none')) {
              subsribePopup.classList.add('d-none');
            }
        ...
        searchBtn.forEach(function (element) {
        ...
        searchPopupContainer.addEventListener('mouseleave', function () {
          if (!searchPopup.classList.contains('d-none')) {
            searchPopup.classList.add('d-none');
          }
        });
        imageGalleries = document.querySelectorAll('.gallery');
        imageGalleries.forEach(/*#__PURE__*/function () {
          var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(gallery) {
            var getMaxDotsRowWidth, updateArrowPosition, flkty;
            return _regenerator().w(function (_context) {
              while (1) switch (_context.n) {
                case 0:
                  getMaxDotsRowWidth = function getMaxDotsRowWidth(dotsContainer) {
                    var dots = _toConsumableArray(dotsContainer.querySelectorAll('.flickity-page-dot'));
                    var rows = {};
                  ...
                  updateArrowPosition = function updateArrowPosition() {
                    var dots = gallery.querySelector('.flickity-page-dots');
                    var prevButtons = gallery.querySelector('.previous');
                    var nextButtons = gallery.querySelector('.next');
                    var fullWidth = dots.offsetWidth;
                    var realWidth = getMaxDotsRowWidth(dots);
                    var ratio = realWidth / fullWidth;
                    if (ratio >= .8) {
                      return;
                    }
                    gallery.querySelector('.previous').style.setProperty('left', "calc(".concat((1 - ratio) / 2 * 100, "% - ").concat(prevButtons.offsetWidth, "px)"), 'important');
                    gallery.querySelector('.next').style.setProperty('right', "calc(".concat((1 - ratio) / 2 * 100, "% - ").concat(nextButtons.offsetWidth, "px)"), 'important');
                  };
                  _context.n = 1;
                  return new (flickity__WEBPACK_IMPORTED_MODULE_2___default())(gallery, {
                    freeScroll: false,
                    wrapAround: true,
                    autoPlay: true,
                    cellAlign: 'center',
        ...
        carouselGallery = document.querySelector('.carousel-gallery');
        if (carouselGallery) {
          flkty = new (flickity__WEBPACK_IMPORTED_MODULE_2___default())(carouselGallery, {
            freeScroll: false,
            wrapAround: true,
            pageDots: true,
            autoPlay: false,
          ...
          carouselNavigationGallery = document.querySelector('.carousel-navigation-gallery');
          flktyNavGallery = new (flickity__WEBPACK_IMPORTED_MODULE_2___default())(carouselNavigationGallery, {
            freeScroll: false,
            wrapAround: true,
            pageDots: false,
            autoPlay: false,
          ...
          carouselNav = document.querySelectorAll('.carousel-nav');
          carouselNav.forEach(function (element) {
            element.addEventListener('click', function () {
          ...
          flkty.on('change', function () {
            ...
            var id = currentSlide.dataset.id;
            flktyNavGallery.selectCell('#carousel-nav-' + id);
          });
          flktyNavGallery.on('change', function () {
            var element = flktyNavGallery.selectedElement;
            var id = element.dataset.id;
            flkty.selectCell('#carousel-slide-' + id);
          });
        }
        moreCategoryArticle = document.querySelector('.more-category-article');
        if (moreCategoryArticle) {
          page = 2;
          length = 10;
          term_id = moreCategoryArticle.dataset.term_id;
          moreCategoryArticle.addEventListener("click", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
            var content, res, articleContainer, _t;
            return _regenerator().w(function (_context3) {
              while (1) switch (_context3.p = _context3.n) {
                case 0:
                  content = moreCategoryArticle.innerHTML;
                  moreCategoryArticle.disabled = true;
                  moreCategoryArticle.innerHTML = '<div class="loader"></div>';
                  _context3.p = 1;
                  _context3.n = 2;
                  return fetch("/wp-admin/admin-ajax.php?".concat(new URLSearchParams({
                    ...
                    var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(response) {
                ...
                case 2:
                  res = _context3.v;
                  articleContainer = document.querySelector('#category-container');
                  res.data.forEach(function (row) {
                    articleContainer.insertAdjacentHTML('beforeend', "<div class=\"col-lg-12 col-sm-6 pb-3 pb-md-4\">".concat(row, "</div>"));
                  });
                  page++;
                  _context3.n = 4;
                  break;
        ...
        moreArticle = document.querySelector('.more-article-btn');
        if (moreArticle) {
          _page = 2;
          _length = moreArticle.dataset.length;
          moreArticle.addEventListener("click", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
            var content, res, articleContainer, _t2;
            return _regenerator().w(function (_context5) {
              while (1) switch (_context5.p = _context5.n) {
                case 0:
                  content = moreArticle.innerHTML;
                  ...
                  return fetch("/wp-admin/admin-ajax.php?".concat(new URLSearchParams({
                    ...
                    var _ref6 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(response) {
                ...
                case 2:
                  res = _context5.v;
                  articleContainer = document.querySelector('#latest-container');
                  res.data.forEach(function (row) {
                    articleContainer.insertAdjacentHTML('beforeend', "<div class=\"col-lg-4 col-md-6 pb-3 pb-md-4\">".concat(row, "</div>"));
                  });
                  _page++;
                  _context5.n = 4;
                  break;
...
/******/ 	__webpack_require__.O(undefined, ["style"], () => (__webpack_require__("./assets/dist/js/scripts.js")))
