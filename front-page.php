        ...
        <div class="container">
            <section id="magazine-subscribe" class="py-5">
                ...
                <div class="text-center">
                    ...
                    <a target="_blank" href="https://www.magzter.com/MY/Indochine-Media/Robb-Report-Malaysia/Lifestyle/?utm_source=cj-cps&cjevent=612b9ff3d3dd11f0829401a20a18b8f6" class="text-uppercase text-white btn btn-danger rounded-0 px-4 py-2 mulish fw-light ls-1"><span class="mulish fw-light">DIGITAL</span></a>
                </div>
            </section>
        </div>
    </div>
