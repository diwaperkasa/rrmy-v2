                    ...
                    <header class="post__header py-4" role="heading">
                        ...
                        <div class="post__share-btn mb-3">
                            <div class="d-flex justify-content-center">
                                <button data-sharer="facebook" data-title="<?= the_title() ?>" data-url="<?= the_permalink() ?>" style="height:40px; width:40px" class="mx-2 btn border border-dark rounded-circle d-flex justify-content-center align-items-center p-0">
                                ...
                                <button data-sharer="linkedin" data-title="<?= the_title() ?>" data-url="<?= the_permalink() ?>" style="height:40px; width:40px" class="mx-2 btn border border-dark rounded-circle d-flex justify-content-center align-items-center p-0">
                                ...
                                <button data-sharer="email" data-title="<?= the_title() ?>" data-url="<?= the_permalink() ?>" style="height:40px; width:40px" class="mx-2 btn border border-dark rounded-circle d-flex justify-content-center align-items-center p-0">
                                ...
                                <button data-sharer="whatsapp" data-title="<?= the_title() ?>" data-url="<?= the_permalink() ?>" style="height:40px; width:40px" class="mx-2 btn border border-dark rounded-circle d-flex justify-content-center align-items-center p-0">
                                        ...
                                        <div class="border bg-white">
                                            <ul class="nav nav-tabs" id="packageTab" role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link rounded-0 border-0 active mulish text-dark" id="overview-tab" data-bs-toggle="tab" data-bs-target="#overview" type="button" role="tab" aria-controls="overview" aria-selected="true">Overview</button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link rounded-0 border-0 mulish text-dark" id="detail-tab" data-bs-toggle="tab" data-bs-target="#detail" type="button" role="tab" aria-controls="detail" aria-selected="false">Details</button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link rounded-0 border-0 mulish text-dark" id="request-tab" data-bs-toggle="tab" data-bs-target="#request" type="button" role="tab" aria-controls="request" aria-selected="false">Request</button>
                                                </li>
                                            </ul>
                                            <div class="tab-content" id="packageTabContent">
                                                ...
                                                <div class="tab-pane fade p-3" id="detail" role="tabpanel" aria-labelledby="detail-tab">
                                                    <?= apply_filters('the_content', get_field('details', get_the_ID()));?>
                                                    <?php the_excerpt(); ?>
                                                </div>
                                                <div class="tab-pane fade p-3" id="request" role="tabpanel" aria-labelledby="request-tab">
                                                    <h2 class="oranienbaum"><?php echo get_the_title(); ?></h2>
                                                    <h4 class="mulish"><?php echo package_price(); ?></h4>
                                                    <?= do_shortcode('[contact-form-7 id="653" title="Request Form"]'); ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
