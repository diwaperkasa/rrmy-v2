                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="post__content lora mb-5  border-bottom">
                                        <?php
                                        if ( have_rows('layout', $post->ID) ):
                                            while ( have_rows('layout', $post->ID) ) : the_row();
                                                if ( get_row_layout() == 'full_width_image' ):
                                                    $image = get_sub_field('image');
                                                    $size = 'full'; // (thumbnail, medium, large, full or custom size) ?>
                                                    <figure class="wp-caption aligncenter"><?= wp_get_attachment_image( $image, $size ) ?></figure>
                                                <?php elseif ( get_row_layout() == 'mixed_content' ):  ?>
